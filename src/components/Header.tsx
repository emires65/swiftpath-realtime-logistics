      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <form onSubmit={handleTrackingSubmit} className="flex items-center space-x-2">
              <Input type="text" placeholder="Enter tracking ID" value={trackingId} onChange={e => setTrackingId(e.target.value)} className="w-48" />
        ...
        {isMenuOpen && <div className="lg:hidden mt-4 pb-4 border-t border-border">
            <div className="flex flex-col space-y-4 pt-4">
              <form onSubmit={handleTrackingSubmit} className="flex items-center space-x-2">
                <Input type="text" placeholder="Enter tracking ID" value={trackingId} onChange={e => setTrackingId(e.target.value)} className="flex-1" />
                <Button type="submit" size="sm" className="bg-primary hover:bg-primary/90">
                  Track
                </Button>
              </form>
